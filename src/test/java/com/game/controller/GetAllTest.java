...
public class GetAllTest extends AbstractTest {
    ...
    public void getAllWithFiltersNamePageNumber() throws Exception {
        ResultActions resultActions = mockMvc.perform(get("/rest/players?name=ра"))
                .andExpect(status().isOk());
    ...
    public void getAllWithFiltersAfterBeforeMinExperienceMaxExperience() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(get("/rest/players?after=1104530400000&before=1230760800000&minExperience=30000&maxExperience=1000000"))
                .andExpect(status().isOk());
